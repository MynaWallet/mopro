...
fn main() -> Result<()> {
    ...
    let zkey_path = format!("examples/circom/selective-disclosure/circuit_final.zkey");
    let wasm_path = format!("examples/circom/selective-disclosure/selective-disclosure.wasm");
    let arkzkey_path = format!("examples/circom/selective-disclosure/circuit_final.arkzkey");
